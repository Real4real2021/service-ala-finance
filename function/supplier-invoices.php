    ...
    foreach ($references as $reference) {
        if (isset($items[$reference])) {
            foreach ($items[$reference] as $item) {
                ...
                $query = "INSERT INTO service_de_financea.supplier_invoices (reference, supplier, date, supplierRef, dueDate, paymentTerms, dimensions, supplierCurrency, exchangeRate, taxGroup, currentCredit, account, name, dimension, amount, memo) 
