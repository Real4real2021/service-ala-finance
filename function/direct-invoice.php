...
if(isset($_POST["referance"])){
    ...
    $query = "INSERT INTO service_de_financea.direct_invoice (referance, itemCode, description, quantity, unit, priceAfterTax, discount) VALUES('$referance','$itemCode','$description','$quantity','$unit','$priceAfterTax','$discount')";
